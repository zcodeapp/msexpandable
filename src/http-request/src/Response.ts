...
export class Response<B = any> implements IResponse<B> {
  ...
  public setHeader(name: string, value: string): IResponse<B> {
    this._responseData = {...this._responseData, ...{ headers: [ ...this._responseData.headers, ...[{ name, value }] ] } };
    return this;
  }

  public setCookie(name: string, value: string): IResponse<B> {
    this._responseData = {...this._responseData, ...{ cookies: [ ...this._responseData.cookies, ...[{ name, value }] ] } };
    return this;
  }

  public redirect(status: ERequestStatus | string, redirect?: string): IResponse<B> {
    if (typeof status == "string") {
      redirect = status;
      status = ERequestStatus.PERMANENT_REDIRECT;
    }
    this._responseData = {...this._responseData, ...{ redirect, statusCode: status }};
    return this;
  }
