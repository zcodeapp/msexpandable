...
describe('Methods test', () => {
  ...
  it('Test methods populate route controller using RoutePathMethodsController', () => {
    ...
    items.map((item) => {
      const controller = controllerManager
        .getControllers()
        .find(
          (x) => x.key == RoutePathMethodsController.name.toLocaleLowerCase()
        )
      const methods = controllerManager.getRoutes()
      const method = methods.find((x) => {
        return (
          x.key == RoutePathMethodsController.name.toLocaleLowerCase() &&
  ...
  it('Test methods populate empty route controller using RoutePathEmptyMethodsController', () => {
    ...
    items.map((_method) => {
      const controller = controllerManager
        ...
        .find(
          (x) =>
            x.key == RoutePathEmptyMethodsController.name.toLocaleLowerCase()
        )
      const methods = controllerManager.getRoutes()
      const method = methods.find((x) => {
        return (
    ...
    items.map((_method) => {
      const controller = controllerManager
        ...
        .find(
          (x) =>
            x.key ==
            RoutePathEmptyUseMethodsControllers.name.toLocaleLowerCase()
        )
      const methods = controllerManager.getRoutes()
      const method = methods.find((x) => {
        return (
  ...
  it('Test methods populate controller middlewares using MiddlewareController', () => {
    const controller = controllerManager
      .getControllers()
      .find((x) => x.key == MiddlewareController.name.toLocaleLowerCase())
    expect(controller?.options?.middlewares).toStrictEqual([
  ...
  it('Test methods populate route middlewares using MiddlewareRouteController', () => {
    ...
    items.map((_method) => {
      ...
      const method = methods.find((x) => {
        return (
          x.key == MiddlewareRouteController.name.toLocaleLowerCase() &&
          x.method == _method
        )
      })
      expect(method?.middlewares).toStrictEqual([
        MiddlewareDependency,
        MiddlewareRouteDependency
      ])
    })
  })
  ...
  it('Test methods populate route middlewares with empty controller middleware using MiddlewareRouteEmptyController', () => {
    ...
    items.map((_method) => {
      ...
      const method = methods.find((x) => {
        return (
          x.key == MiddlewareRouteEmptyController.name.toLocaleLowerCase() &&
          x.method == _method
        )
      })
  ...
  it('Test methods populate controller interceptors using InterceptorController', () => {
    const controller = controllerManager
      .getControllers()
      .find((x) => x.key == InterceptorController.name.toLocaleLowerCase())
    expect(controller?.options?.interceptors).toStrictEqual([
      InterceptorDependency
    ])
  })
  ...
  it('Test methods populate route interceptors using InterceptorRouteController', () => {
    ...
    items.map((_method) => {
      ...
      const method = methods.find((x) => {
        return (
          x.key == InterceptorRouteController.name.toLocaleLowerCase() &&
          x.method == _method
        )
      })
      expect(method?.interceptors).toStrictEqual([
        InterceptorDependency,
        InterceptorRouteDependency
      ])
    })
  })
  ...
  it('Test methods populate route interceptors with empty controller interceptor using InterceptorRouteEmptyController', () => {
    ...
    items.map((_method) => {
      ...
      const method = methods.find((x) => {
        return (
          x.key == InterceptorRouteEmptyController.name.toLocaleLowerCase() &&
          x.method == _method
        )
      })
  ...
  it('Test summary controller using SummaryController', () => {
    const controller = controllerManager
      .getControllers()
      .find((x) => x.key == SummaryController.name.toLocaleLowerCase())
  ...
  it('Test summary routes using SummaryRoutesController', () => {
    ...
    items.map((item) => {
      ...
      const method = methods.find((x) => {
        return (
          x.key == SummaryRoutesController.name.toLocaleLowerCase() &&
          x.method == item.method
        )
      })
  ...
  it('Test response status controller using ResponseStatusController.ts', () => {
    const controller = controllerManager
      .getControllers()
      .find((x) => x.key == ResponseStatusController.name.toLocaleLowerCase())
  ...
  it('Test response status routes using ResponseStatusRouteController', () => {
    ...
    items.map((item) => {
      ...
      const method = methods.find((x) => {
        return (
          x.key == ResponseStatusRouteController.name.toLocaleLowerCase() &&
          x.method == item.method
        )
      })
