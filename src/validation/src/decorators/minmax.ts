import { EValidationTypes, IValidation, IValidationOptions } from "@zcodeapp/interfaces";
...
export function decoratorMinMax(type: EValidationTypes) {
    return function(min?: number | IValidationOptions, max?: number, options?: IValidationOptions) {
      options = {
        ... options ?? {},
        min: 0,
        max: 255
